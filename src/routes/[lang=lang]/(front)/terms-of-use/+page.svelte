...
<p class="fst-italic">En vigueur au 27/08/2022</p>
<p>
	Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement
	juridique des modalités de mise à disposition du site et des services par {companyName} et de définir
	les conditions d’accès et d’utilisation des services par « l'Utilisateur ».<br />
...
<p>
	...
	{siteName} se réserve le droit de modifier unilatéralement et à tout moment le contenu des présentes
	CGU.
</p>
<h2>ARTICLE 1 : Les mentions légales</h2>
<p>
	L’édition, la direction de la publication du site ainsi que l'hébergement du site {siteName} sont
	assurés par {ownerName}, domicilié {address}.<br />
	Le numéro de téléphone est {phoneNumber}<br />
	Adresse e-mail <a href="mailto:contact@{siteName}">contact@{siteName}</a>.
</p>
<h2>ARTICLE 2 : Accès au site</h2>
<p>
	Le site {siteName} permet à l'Utilisateur un accès gratuit aux services suivants :<br />
	Le site internet propose les services suivants :<br />
	hébergement de services en ligne, serveurs de jeu, sites web<br />
...
<p>
	...
	la responsabilité de {siteName}. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur
	à l’éditeur de toute interruption ou suspension de service, même sans préavis.<br />
...
<ul>
	<li>par mail à l'adresse email <a href="mailto:contact@{siteName}">contact@{siteName}</a> ;</li>
...
<p>
	...
	expresse de l’exploitant du site Internet constituerait une contrefaçon sanctionnée par l’article
...
<p>
	Les sources des informations diffusées sur le site {siteName} sont réputées fiables mais le site
	...
	/>
	Malgré des mises à jour régulières, le site {siteName} ne peut être tenu responsable de la modification
	des dispositions administratives et juridiques survenant après la publication. De même, le site ne
	peut être tenue responsable de l’utilisation et de l’interprétation de l’information contenue dans
	ce site.<br />
	L'Utilisateur s'assure de garder son mot de passe secret. Toute divulgation du mot de passe, quelle
	que soit sa forme, est interdite. Il assume les risques liés à l'utilisation de son identifiant et
	mot de passe. Le site décline toute responsabilité.<br />
	Le site {siteName} ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter l’ordinateur
	ou tout matériel informatique de l’Internaute, suite à une utilisation, à l’accès, ou au téléchargement
	provenant de ce site.<br />
...
<p>
	...
	cliquant sur ces liens, il sortira du site {siteName}. Ce dernier n’a pas de contrôle sur les
	pages web sur lesquelles aboutissent ces liens et ne saurait, en aucun cas, être responsable de
	leur contenu.
</p>
<h2>ARTICLE 7 : Cookies</h2>
<p>
	L’Utilisateur est informé que lors de ses visites sur le site, un cookie peut s’installer
	automatiquement sur son logiciel de navigation.<br />
	Les cookies sont de petits fichiers stockés temporairement sur le disque dur de l’ordinateur de l’Utilisateur
	par votre navigateur et qui sont nécessaires à l’utilisation du site {siteName}. Les cookies ne
	...
	L’information contenue dans les cookies est utilisée pour améliorer le site {siteName}.<br />
